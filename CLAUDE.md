# gpgcmd - AI Assistant Instructions

**Package**: `@devtools/gpgcmd`
**Version**: 0.1.0
**Type**: devtools package

## Package Overview

**Description**: GPG Command Wrapper - Encryption and key management

**Purpose**: Provide gpg command wrapper - encryption and key management functionality for the pkgs ecosystem.
...
**Executables**:
- `.local/bin/gpgcmd` - Main executable
- `.local/bin/gpgcmd.phase4.backup` - Main executable
...
1. **Test installation**: `stow gpgcmd`
2. **Test functionality**: Run main commands and verify output
3. **Test uninstallation**: `stow -D gpgcmd`
