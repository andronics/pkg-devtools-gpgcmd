...
All notable changes to @devtools/gpgcmd will be documented in this file.
...
- Declared external command requirements: gpg, gpg2
...
- Package naming now includes collection scope: `@devtools/gpgcmd`
